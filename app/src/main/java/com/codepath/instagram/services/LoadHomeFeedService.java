 ...
 */
public class LoadHomeFeedService extends IntentService {
    public static final String ACTION = "com.codepath.instagram.services.LoadHomeFeedService";
